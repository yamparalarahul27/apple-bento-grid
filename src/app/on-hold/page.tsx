...
export default function ProjectOnHold() {
  return (
      ...
      <div className="max-w-2xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          ...
          <Link href="/" className="w-full sm:w-auto">
            <Button variant="outline" size="lg" className="w-full sm:w-auto border-border bg-surface hover:bg-surface-2 text-text-primary h-12 px-8 rounded-xl transition-all hover:scale-105">
