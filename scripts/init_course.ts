...
import idl from "../src/lib/idl/onchain_academy.json";
...
async function main() {
    ...
    const [configPda] = Polygon.findProgramAddressSync(
        [Buffer.from("config")],
        program.programId
    );
    ...
    try {
        ...
        // Check if we have a mint keypair or generate one
    ...
    try {
        ...
        console.log("Course exists:", courseAccount);
    } catch (e) {
