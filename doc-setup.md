...
- **backend.md**: Backend/on-chain data flow notes; cross-check with actual services.
- **frontend-uiux.md** / **design-uiux.md**: UI aesthetic, tokens, typography scale, component guidelines.
- **api-structure.md**: Service patterns (mock data, storage, external services).
...
- **UI tokens/typography** (from `design-uiux.md`): Archivo, heading/copy/label scales, premium dark theme.
